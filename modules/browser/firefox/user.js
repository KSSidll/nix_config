...
// don't sanitize too much, make the browser usable
...
// can't be that bad.. right?? (last time i checked kotlin multiplatform pages didn't work with it disabled)
// deprecated
// user_pref("webgl.disabled", false);

// enable since duck duck is potentially somewhat more private than google
user_pref("browser.search.suggest.enabled", true);
user_pref("browser.urlbar.suggest.searches", true);

// don't separate private default search as we use duck duck
...
user_pref("browser.toolbars.bookmarks.visbility", "always");
...
// Don't trim  URL (looks worse but you want to know this when looking at url)
